...
// ponytail: duration is ffprobe of public/gadai-demo.mp4 (187.7 s); re-probe if the MP4 is replaced.
const CHECK = [
    ...
    <div className="space-y-10">
      ...
      <figure>
        ...
        <figcaption className="mt-2 text-sm text-mute">
          <a className="link" href="/gadai-demo.mp4" download>Download the MP4</a> · <span className="num">3:08</span> · narrated, subtitled
        </figcaption>
      </figure>
      <section>
